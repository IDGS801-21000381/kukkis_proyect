...
function cargarModuloVentas() {
    fetch('/admin/ventas/ventas.html')
        .then(respuesta => {
            if (!respuesta.ok) {
                throw new Error('No se pudo cargar el contenido de ventas.html');
            }
...
function cargarContenido(categoria) {
    ...
    switch (categoria) {
        case 'pieza':
            ruta = '/admin/ventas/VentaPieza.html';
            break;
        case 'peso':
            ruta = '/admin/ventas/VentaPeso.html';
            break;
        case 'cantidad':
            ruta = '/admin/ventas/VentaCantidad.html';
            break;
        case 'caja':
            ruta = '/admin/ventas/VentaCaja.html';
            break;
        default:
